<script lang="ts">
	import { Carousel, CarouselButton, CarouselItem } from 'svelte-inplace-carousel';
</script>

<Carousel>
	<svelte:fragment let:kind slot="prev">
		<CarouselButton {kind} class="scale-150">◀️</CarouselButton>
	</svelte:fragment>
	<svelte:fragment let:kind slot="next">
		<CarouselButton {kind} class="scale-150">▶️</CarouselButton>
	</svelte:fragment>
	<CarouselItem>
